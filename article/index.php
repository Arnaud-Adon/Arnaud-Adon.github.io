...
<html>
    ...
    <body>
        ...
        <header>      
            <nav>
                <marquee class="warning">URGENT : Nouveaux articles</marquee>
                <?php if (isset($_SESSION['login'])) { ?> 
                    ...
                    <div id="sign">
                        <form action="#" method="post">
                            ...
                            <label for="login">Login</label><input id="login" type="text" name="login" width="100" size="40" placeholder="Entrer votre pseudo" value="">


                            <label for="password">Mot de passe</label><input id="password" type="password" name="password" size="40" placeholder="Entrer votre mot de passe" value="">

                            <input class="submit" type="submit" value="Validez"><a href="inscription.php">S'inscrire</a><br>                                                             
                        </form>                       
                    </div>
                    <div id="nav">
                        <ul>
        ...
        <section>            
            <article>
                ...
                <h1>Lorem ipsum</h1>
                <h4><em>Par Lorem, le 27 novembre 2017</em></h4>
                ...
                <div id="sprite">
                    ...
                    <a href="#"><i class="sprite sprite-linkedin"></i></a>
                    <a href="#"><i class="sprite sprite-tumblr"></i></a>
                    <a href="#"><i class="sprite sprite-twitter"></i></a>
                </div>
            </article>
            <aside>
                <div id="pub"><img src="img/journal.jpg" alt="journal"></div>
